...
const welcomeScreen = (): TelegramScreen<welcomeCallbacks> => {
  const text = createText([
    ...
    {
      sentence: " Wellcome to the sesame bot 1993",
      style: { strong: true, underline: true, jumpLine: true },
    },
  ...
  return {
    text,
    keyboard: [
      [createButton<welcomeCallbacks>("We only live once, lets go!", "wellcomeScreen: Conditions")],
    ],
