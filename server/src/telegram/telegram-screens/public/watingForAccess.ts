...
const waitingForAccessScreen = (): TelegramScreen<never> => {
  const text = createText([
    ...
    {
      sentence: "It seems that some people is using me without the permission of my: ",
      style: { jumpLine: true },
    },
    { sentence: "", style: { jumpLine: true } },
    ...
    {
      sentence:
        "I have sent a message with your information to my owner, wait for him to accept you.",
      style: { jumpLine: true },
    },
  ]);
